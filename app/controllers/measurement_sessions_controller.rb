class MeasurementSessionsController < ApplicationController
  ...
  def show
    form = Api::ParamsForm.new(params: params.to_unsafe_hash, schema: Api::Links::Schema, struct: Api::Links::Struct)
  ...
  def show_old
    ...
    session = Session.find_by_url_token(params.to_unsafe_hash[:url_token]) or raise NotFound
