class Outliers::FilterMeasurements
  ...
  MAX_DISTANCE = 5
  # If detected outliers are more than 5% of the measurements do not filter anything
  THRESHOLD = 0.05

  def initialize(
    calculate_centroid = Outliers::CalculateCentroid.new,
    filter = Outliers::FilterMeasurementsFartherThan.new(MAX_DISTANCE, THRESHOLD, Outliers::CalculateDistance.new)
  )
