module AirNow
  ...
  def self.defaults_by_sensor_name(sensor_name)
    {
      'PM2.5' => {
        sensor_name: 'Government-PM2.5',
  ...
  Stream = Struct.new(
    ...
    def assign_defaults(sensor_name)
      AirNow.defaults_by_sensor_name(sensor_name)
