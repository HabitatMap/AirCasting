...
activeToggleFilter =
    TooltipText "Fixed sessions that have submitted a measurement in the past 12 hours are considered active. Fixed sessions that have not submitted measurements in the past 12 hours are considered dormant."
