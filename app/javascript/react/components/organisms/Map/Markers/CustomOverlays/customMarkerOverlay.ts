function createCustomMarkerOverlayClass() {
...
let _CustomMarkerOverlayClass: ReturnType<
  typeof createCustomMarkerOverlayClass
> | null = null;

export function getCustomMarkerOverlayClass() {
  if (!_CustomMarkerOverlayClass) {
    _CustomMarkerOverlayClass = createCustomMarkerOverlayClass();
  }
  return _CustomMarkerOverlayClass;
}

export type CustomMarkerOverlay = InstanceType<
  ReturnType<typeof createCustomMarkerOverlayClass>
>;
