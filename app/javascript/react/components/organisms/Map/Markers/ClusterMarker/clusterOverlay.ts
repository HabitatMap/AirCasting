...
function createClusterOverlayClass() {
  return class ClusterOverlay extends google.maps.OverlayView {
    ...
    private handleClick = (event: MouseEvent) => {
      ...
      this.onClick(
        event as unknown as google.maps.MapMouseEvent,
        this.cluster
      );
    };
...
let _ClusterOverlayClass: ReturnType<typeof createClusterOverlayClass> | null =
  null;

export function getClusterOverlayClass() {
  if (!_ClusterOverlayClass) {
    _ClusterOverlayClass = createClusterOverlayClass();
  }
  return _ClusterOverlayClass;
}

export type ClusterOverlay = InstanceType<
