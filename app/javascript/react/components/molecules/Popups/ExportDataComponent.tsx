...
import { BlueButton, FormWrapper } from "../../organisms/Modals/Modals.style";
import {
  ModalInput,
  RedErrorMessage,
} from "../../organisms/Modals/atoms/ModalInput";
...
const ExportDataComponent = ({
  ...
  const handleSubmit = (
    ...
    dispatch(exportSession({ sessionsIds, email: formState.email, sensorName }));
    onSubmit(formState);
